	...
	// Pass this if window is not defined yet
		...
		(
				...
				function(window, noGlobal) {
					...
					jQuery
							.extend({
								...
								type : function(obj) {
									...
									// Support: Android<4.0, iOS<6 (functionish
									// RegExp)
					...
					// 1.9.x branch
					// 2. Improve the module's maintainability by reducing the
					// storage
					// paths to a single mechanism.
					// 3. Use the same single mechanism to support "private" and
					// "user" data.
					// 4. _Never_ expose "private" data to user code (TODO: Drop
					// _data, _removeData)
					// 5. Avoid exposing implementation details on user objects
					// (eg. expando properties)
					// 6. Provide a clear path for implementation upgrade to
					// WeakMap in 2014
					...
					jQuery
							.extend({
								...
								// Not public - generate a queueHooks object, or
					...
					function actualDisplay(name, doc) {
						...
						// optimization) until something better comes along,
					...
					function getWidthOrHeight(elem, name, extra) {
						...
						if (val <= 0 || val == null) {
							...
							// Check for style in case a browser which returns
							// unreliable values
							...
							.extend({
								...
								style : function(elem, name, value, extra) {
									...
									if (value !== undefined) {
										...
										// If a number, add 'px' to the (except
										...
										// Support: IE9-11+
										// background-* props affect original
										// clone's values
								...
								css : function(elem, name, extra, styles) {
									...
									// Try prefixed name followed by the
									// unprefixed name
									hooks = jQuery.cssHooks[name]
											|| jQuery.cssHooks[origName];
									...
									// Make numeric if forced or a qualifier was
					...
					Tween.propHooks = {
						_default : {
							get : function(tween) {
								...
								// if the parse fails.
								// Simple values such as "10px" are parsed to
								// Float;
							...
							set : function(tween) {
								...
								// Use .style if available and use plain
					...
					function defaultPrefilter(elem, props, opts) {
						...
						if (!opts.queue) {
							...
							anim.always(function() {
								// Ensure the complete handler is called before
								// this completes
								anim.always(function() {
									hooks.unqueued--;
					...
					function propFilter(props, specialEasing) {
						...
						for (index in props) {
							...
							if (hooks && "expand" in hooks) {
								...
								// Not quite $.extend, this won't overwrite
								// existing keys.
								// Reusing 'index' because we have the correct
								// "name"
								for (index in value) {
									if (!(index in props)) {
					...
					(function() {
						...
						// Support: Android<=2.3
						// Options inside disabled selects are incorrectly
						// marked as disabled
								...
								ajax : function(url, options) {
									...
									function done(status, nativeStatusText,
										...
										if (isSuccess) {
											...
											// Extract error from statusText and
											// normalize for non-aborts
											error = statusText;
					...
					jQuery.fn
							.extend({
								offset : function(options) {
									...
									// Support: BlackBerry 5, iOS 3 (original
									// iPhone)
								...
								position : function() {
									...
									if (jQuery.css(elem, "position") === "fixed") {
										// Assume getBoundingClientRect is there
